  ...
  <view class="dispatch" v-show="value">
    <view id="front" class="sub">
      <view class="main">
        ...
        /> -->
          <image
            src="../../../static/images/con-center/cheap.png"
            mode="scaleToFill"
            class="text"
          />
          <image
            src="../../../static/images/con-center/hongbao.png"
            mode="scaleToFill"
            class="discount"
          />
        </view>
      ...
      <view
        class="foot animate__animated animate__bounce"
        @click="handleToViewDetail"
      >
        <text>立即使用</text>
      </view>
      <!-- <JIcon
...
.dispatch {
  ...
  .sub {
    ...
    .foot {
      ...
      background: linear-gradient(270deg, #8a38f5 2%, #07c2fb 78%);
      box-sizing: border-box;
      border-image: linear-gradient(180deg, #ffffff 0%, #3662ec 100%) 1;
      font-size: 36upx;
      font-weight: 500;
      color: #ffffff;
    }
