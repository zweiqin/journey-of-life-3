	...
	<view class="login-container">
		...
		<view class="login-main-area">
	        ...
	        ">
				...
				<navigator class="forget-assword" url="/pages/reset-password/reset-password" hover-class="none">
					忘记密码
				</navigator>
			</view>

			<button class="login-btn uni-btn" :style="{ background: btnStatus ? '#FFC117' : '' }" @click="onlogin">
				登录
			</button>
