<template>
    <view class="container">
            ...
            <tui-form ref="form" :show-message="false">
                ...
                <view class="formItem">
					<tui-input placeholder-class="inputs" type="password"
						...
						placeholder="请输入新密码" backgroundColor="" :borderTop="false"
						color="#222229" :clearable="true" size="34"
						@confirm="handleClickConfirmType(0)"
					></tui-input>
				</view>
        ...
        <button class="loginBtn" :class="{ disbleds: disbleds }" @click="resetPassword">确定</button>
        <view class="agreement">
            登录即代表你已阅读并同意<text class="agreementDetails">《用户服务协议》{{ disbleds }}</text>
        </view>
        <tui-toast ref="toast"></tui-toast>
        <tui-modal :show="isOk" custom :fadeIn="true" :button="[]" @cancel="isOk = false">
            <view style="padding: 28upx 0;text-align: center;">
                <image style="width: 240rpx;height: 144rpx;" src="@/static/images/icon/setPwd.png"></image>
                <view class="text">修改完成</view>
                <view class="text2">您已完成密码更改，请前往登录</view>
                <button @click="go('/pages/login/pwdLogin')" style="width: 484rpx;height: 80rpx;border-radius: 8rpx;background: #EF530E;color: #fff;line-height: 80rpx;margin-top: 80rpx;">立即登录</button>
            </view>
        </tui-modal>
    </view>
</template>
