export const navs = [
  ...
  {
    icon: 'https://www.tuanfengkeji.cn:9527/jf-admin-api/admin/storage/fetch/83z8x86jmm7y7rx9oqsx.png',
...
export const topMenu = [
  ...
  {
    label: '行业资讯',
    url: '/stuff/industry/infomation-list',
  },
]

export const supplyListHeader = [
  {
    title: '类别',
