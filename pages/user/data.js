...
import { ANOTHER_TF_SETTLE, ENV } from './../../config'

const envUrl = ENV === 'development' ? 'test' : 'www'
...
export const additionalFunction = [
  ...
  },
  {
    ...
    type: 'external',
    url: `https://${envUrl}.zhult.com/shifu/`
  },
  {
    name: '店长端',
    icon: require('../../static/images/new-user/menu-icon/dianzhangduan.png'),
    type: 'external',
    url: `https://${envUrl}.zhult.com/zhanzhang/#/login`
  },
  {
    name: '选品中心',
    icon: require('../../static/images/new-user/menu-icon/fensitongji.png'),
...
export const otherFunction = [
  ...
  },
  {
    name: '临时活动',
    icon: require('../../static/images/new-user/menu-icon/fensitongji.png'),
    url: '/another-tf/another-user/temporary-recruitment-activities/index'
  },
  {
    name: '我的抽奖',
    icon: require('../../static/images/new-user/menu-icon/zhinenghuace.png'),
