	...
	<view class="add-site-container">
		...
		<view class="add-site-content">
			<view class="item-wrapper">
				...
				<view class="add-site-value"><input v-model="form.name" type="text" class="common-text" placeholder="请填写姓名"
			...
			<view class="item-wrapper">
				...
				<view class="add-site-value"><input v-model="form.mobile" type="text" class="common-text" placeholder="请填写电话"
						style="padding-bottom: 32upx" /></view>
			</view>
			...
			<view class="item-wrapper">
              ...
              font-size: 28upx;
              margin-right: 10upx;
            " :style="{ color: form.detailedAddress ? '' : 'gray' }">{{ form.detailedAddress || "请选择区域" }}</view>
...
<script>
	import {
		data
	} from "stuff/brand-materials/templateDate";
	import {
		getAddressSaveApi,
		getAddressDetailApi,
		updateAddressApi,
