					...
					<view class="color-wrapper">
						...
						<view class="colors">
							<view
								...
								}" style="background: #183869;position: relative;" @click="handleChooseItem(item)"
							>
								<tui-icon
									v-if="currentChooseColor === item" name="circle-selected" color="#ffffff" :size="32"
									unit="upx" style="position: absolute;right: 6upx;bottom: 6upx;"
								></tui-icon>
							</view>
						</view>
					</view>
