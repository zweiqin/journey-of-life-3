		...
		<view class="main">
					...
					<view class="upload-pane">
						<view style="display: flex; flex-wrap: wrap">
							<view v-for="img in images" :key="img"
								style="position: relative;width: 110upx;height: 110upx;margin-right: 20upx;margin-bottom: 20upx;">
			...
			<view class="notice">
				...
				<view class="notice-content">
					<view class="content">
						<textarea name="" id="" cols="30" rows="10" class="show" placeholder="请填写尺寸、体积、重量等信息,方便师傅带齐工具(您上传的照片非常重要哦~)"
