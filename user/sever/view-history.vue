<template>
    ...
    ></JHeader> -->
		...
		<view class="navs">
			...
			<view class="item" @click="handleSwitchTab(item.value)" :class="{ 'item-active': currentPage === item.value }"
				v-for="item in labelList" :key="item.label">{{ item.name }}</view>
		...
		<view class="list-wrapper">
			...
			<Collections @delete="getCollections" v-show="currentPage === 'collection'" :data="collectionInfo.data">
			</Collections>

			<FollowStore @delete="getFollowStoreList" :data="followStore.data" v-show="currentPage === 'follow'"></FollowStore>
