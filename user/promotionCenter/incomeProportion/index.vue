<template>
  <view id="pie1" class="pie1">
    ...
    <view id="main1" style="float: left; width: 100%; height: 600upx"  class="pie"/>
  </view>
</template>
        ...
        series: [
          {
            ...
            data: [
              ...
              { value: 137, name: "微店分红", itemStyle: { color: "#8A38F5" } },
              { value: 213, name: "其他", itemStyle: { color: "#07B9B9" } },
              { value: 358, name: "发现视频", itemStyle: { color: "#0256FF" } },
            ], // data 中的name为formatter中的 b；data中的value呢就是formatter中c；
