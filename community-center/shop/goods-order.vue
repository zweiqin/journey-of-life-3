    ...
    <view class="main-area">
      ...
      <view v-if="orderInfo" class="order container">
        ...
        <view class="number-wrapper">
          ...
          <tui-numberbox :value="orderInfo.number" :min="1" @change="handleChangeNumber"></tui-numberbox>
        </view>

        <view class="words">
          <view class="title">留言</view>
          <textarea id="" v-model.trim="opForm.message" placeholder="可在此给留言给商家" cols="2" maxlength="20" placeholder-class="input-text"></textarea>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    getOrderInfo() {
      ...
      this.calcOrderMsg = {
        goodsTotalPrice: this.orderInfo.currentPrice,
        freightPrice: 0,
        actualPrice: this.orderInfo.currentPrice * this.orderInfo.number
      };
      // this.getCardId();
    },
    ...
    handleChangeNumber(e) {
      ...
      this.calcOrderMsg.actualPrice = (value * this.orderInfo.currentPrice).toFixed(2);
    }
  }
};
</script>
