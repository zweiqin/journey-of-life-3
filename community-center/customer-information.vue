	...
	<view class="customer-information">
		...
		<view class="top">
			...
			<view class="name-list">
				...
				<view class="name">
					<input class="contact" v-model="addname" placeholder="(请输入姓名)" placeholder-class="input-placeholder" />
				</view>
			</view>
			...
			<view class="add-list">
				...
				<view class="addDetail">
					<textarea name="input" class="address" v-model="addressDetail" placeholder="(请输入详细地址)"
		...
		<view class="middle">
			<view class="middle1">
				...
				<view class="add">
					<img src="https://www.tuanfengkeji.cn:9527/dts-admin-api/admin/storage/fetch/ie5tzuaheizwyypdp78e.png" alt=""
						class="img" @click="goodsdelete" />
					<view class="number">{{ number }}</view>
					<img src="https://www.tuanfengkeji.cn:9527/dts-admin-api/admin/storage/fetch/zvm9f03y096iyrjgbuk2.png" alt=""
						class="img" @click="goodsadd" />
				</view>
			</view>
            ...
            <view class="unit">台</view>
				...
				<view class="add">
					<img src="https://www.tuanfengkeji.cn:9527/dts-admin-api/admin/storage/fetch/ie5tzuaheizwyypdp78e.png" alt=""
						class="img" @click="piecedelete" />
					<view class="number">{{ specsId }}</view>
					<img src="https://www.tuanfengkeji.cn:9527/dts-admin-api/admin/storage/fetch/zvm9f03y096iyrjgbuk2.png" alt=""
						class="img" @click="pieceadd" />
				</view>
			</view>
		</view>
			...
			<template v-if="pricingType == 1">
				...
				<view class="coupon-list">
					...
					<view class="text-list">
						...
						<img src="https://www.tuanfengkeji.cn:9527/dts-admin-api/admin/storage/fetch/unclmibq0dktn12nodz0.png" alt=""
							class="more" />
					</view>
				</view>
				<view class="pay-list">
			...
			if (
				...
				this.getServiceOrder((abc) => {
					uni.redirectTo({
						url: `/community-center/confirm-order?name1=${this.name1}&oughtPrice=${this.oughtPrice}&content=${this.content}
        &consigneeName=${this.addname}&consigneeMobile=${this.phoneNumber}&consigneeAddress=${this.address}&consigneeAddressDetail=${this.addressDetail}
        &installDate=${this.datetimerange}&pricingType=${this.pricingType}&images=${JSON.stringify(this.images)}&data=${this.data}`,
					})
				})
