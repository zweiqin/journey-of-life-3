<template>
	<view class="vip-page">
		<!-- header -->
		<VipHeader
			:campaigns-type="campaignsType" :name="type == 2 ? '家庭小卫士' : `(${currentJUHUIdata.serverName || '限时钜惠'})`"
		...
		<view v-if="type == 2" class="pane">
			...
			<PayBar
				:price="type == 2 ? myAttributeVipJInData.serverPrice || 399 : currentJUHUIdata.serverPrice || 39.9"
				@pay="handlePayVip"
			></PayBar>
		</view>
