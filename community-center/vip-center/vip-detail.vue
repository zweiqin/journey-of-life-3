<template>
	<view class="vip-page">
		...
		<VipHeader
			...
			:name="type == 2 ? `${myAttributeVipJInData.serverName || '家庭小卫士'}` : `(${currentJUHUIdata.serverName || '限时钜惠'})`"
		...
		<view v-if="type == 2" class="pane">
			...
			<PayBar
				:price="type == 2 ? myAttributeVipJInData.serverPrice || 299 : currentJUHUIdata.serverPrice || 39.9"
				@pay="handlePayVip"
			></PayBar>
		</view>
