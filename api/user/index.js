...
import { LTRequest, getUserId, RuanRequest, XZLRequest, shopRequest, huangRequest, SheQuRequest1, request2, endRequest } from '../../utils';
...
export const postConversionApi = (ids) => LTRequest(`/api/msgSentry/conversion/${ids.id}/${ids.userId}`, null, 'get');
...
// 申请团长
export const applyRegimentalCommander = (data) =>
  endRequest({
...
// 查询团长审核状态
export const queryApplyRegimentalCommanderStatusApi = (data) => {
  return endRequest({
...
// 获取佣金统计
export const getCommissionDatatApi = (data) => {
  return endRequest({
...
// 获取佣金详情
export const getCommissionDeatilApi = (data) => {
  return endRequest({
...
// 获取推广码
export const getGroupCodeApi = (data) => {
  return endRequest({
