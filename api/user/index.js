...
export const bindLastUserApi = data => {
  return shopRequest('/binding/userBinding', data)
}

// 校验绑定
export const checkBindApi = data => {
  return shopRequest('/binding/checkBinding', data, 'get')
}
...
export const getAccountBookApi = data => {
  return RuanRequest('/smallledger/getSmallLedger', data, 'get')
}
...
export const partnerApplyApi = data => {
  return shopRequest('/api/syb/orderPayH5', data, 'post', null, {
