 ...
 */
import { LTRequest } from "../../utils"

// 业务管理升级
export const upbussinessApi = (data) => {
    return LTRequest("/demo/wx/api/business/setMsgSentryStatus", data)
}
// 业务管理查询
...
export const saveMsgSentryApi  = (data) =>{
    return LTRequest("/demo/wx/api/business/saveMsgSentry",data)
}
...
export const addperformanceApi = (data) =>{
    return LTRequest("/demo/wx/api/performance/savePerformance",data)
}
export const performanceListApi = (data) =>{
    return LTRequest("/demo/wx/api/performance/getPerformanceList",data)
}
export const getPerformanceInfoApi = (data) =>{
    return LTRequest("/demo/wx/api/performance/getPerformanceInfo",data)
}
