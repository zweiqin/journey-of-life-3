...
export const upbussinessApi = (data) =>
  LTRequest("/api/business/setMsgSentryStatus", data);
// 业务管理查询
export const queryMsgSentryListApi = (data) =>
  LTRequest("/api/msgSentry/queryMsgSentryList", data);
// 业务管理新增
export const saveMsgSentryApi = (data) =>
  LTRequest("/api/business/saveMsgSentry", data);
...
export const addperformanceApi = (data) =>
  LTRequest("/api/performance/savePerformance", data);
export const performanceListApi = (data) =>
  LTRequest("/api/performance/getPerformanceList", data);
export const getPerformanceInfoApi = (data) =>
  LTRequest("/api/performance/getPerformanceInfo", data);
...
export const getMarketingPortraitDataApi = () =>
  LTRequest(`/api/statistical/home/${getUserId()}`, null, "get");
...
export const postConversionApi = (ids) =>
  LTRequest(`/api/msgSentry/conversion/${ids.id}/${ids.userId}`, null, "get");
...
export const getWordsApi = (id) =>
  LTRequest(`/api/msgSentry/queryMsgSayList/${id}`, null, "get");
...
export const changeUserStatusApi = (data) =>
  LTRequest("/api/msgSentry/isConversion", data);
...
export const addCustomerApi = (data) =>
  LTRequest("/api/msgSentry/saveWxMsgSentry", data);
...
export const addMyWordsApi = (data) =>
  LTRequest("/api/msgSentry/saveMsgSay", data);
...
export const refrshUserInfoApi = (data) =>
  RuanRequest("/user/refreshUser", data, "get");

// 查询用户足迹
export const getUserViewHistoryApi = (data) =>
  RuanRequest("/footprint/list", data, "get");

// 获取收藏数据
export const getUserCollectionListApi = (data) =>
  RuanRequest("/collect/list", data, "get");
...
export const getExtensionCodeApi = (data) =>
  shopRequest("/binding/getCode", data);

// 绑定上级
export const bindLastUserApi = (data) =>
  shopRequest("/binding/userBinding", data);

// 校验绑定
export const checkBindApi = (data) =>
  shopRequest("/binding/checkBinding", data, "get");
...
export const buildNewMyCardApi = (data) =>
  RuanRequest("/businessCard/add", data);

// 获取名片列表
export const getNameCardList = (data) =>
  RuanRequest("/businessCard/list", data, "get");

// 修改明信片背景色
export const changeNameCardBgApi = (data) =>
  RuanRequest("/businessCard/updateBgColor", data);

// 获取名片详情
export const getNameCardDetailApi = (data) =>
  RuanRequest("/businessCard/detail", data, "get");

// 修改名片
export const updateNameCardApi = (data) =>
  RuanRequest("/businessCard/update", data);

// 小账本
export const getAccountBookApi = (data) =>
  RuanRequest("/smallledger/getSmallLedger", data, "get");
...
export const getBusinessResponsiblePersonListApi = (data) =>
  RuanRequest("/partnerApply/getBusinessResponsiblePersonList", data, "get");

/**
 * 活动中心
 */
// 获取活动中心佣金收益
export const getUserIncomeApi = (data) =>
  RuanRequest(
...
export const getUserCrmListApi = (data) =>
  shopRequest("/userCrm/region", data, "get");

// 粉丝查询
export const getBindingUserApi = (data) =>
  RuanRequest("/userBindingUser/bindingUser", data, "get");

// 分享按钮判断用户是否购买299会员成为金管家
export const getPurchaseRecordApi = (data) =>
  RuanRequest("/userCrm/purchaseRecord", data, "get");

// 分享按钮判断用户是否购买爆款商品
export const getIsPurchaseApi = (data) =>
  RuanRequest("/userCrm/isPurchase", data, "get");

// 生成并返回用户的活动邀请码
export const getCreateCodeApi = (data) =>
  RuanRequest("/infoCode/createCode", data, "get");

// 活动码绑定
export const changeActivityUserBindingApi = (data) =>
  shopRequest("/userBindingUser/userBindingUser", data);

// 服务记录邀请绑定接口
// export const changeServiceUserBindingApi = (data) => shopRequest('/dtsUserSharingLogs/saveLog', data)
export const changeServiceUserBindingApi = (data) =>
  shopRequest("/dtsUserSharingLogs/saveLog", data, "get");

// 查询我的(服务记录)分享数购买数接口
export const getServiceSharingLogsApi = (data) =>
  RuanRequest("/dtsUserSharingLogs/selectId", data, "get");

// 升级(超级)合伙人
export const partnerApplyApi = (data) =>
  shopRequest("/api/syb/orderPayH5", data, "post", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// 升级为门店
export const applyStoreApi = (data) =>
  shopRequest("/partnerApply/saveAndSignin", data, "post", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// 查询图册
export const getUserCrmSlbumList = (data) =>
  shopRequest("/userCrmSlbum/list", data, "get", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// id查询智能图册
export const getUserCrmSlbumSelectId = (data) =>
  shopRequest("/userCrmSlbum/selectId", data, "get", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// 新建智能图册
export const buildUserCrmSlbumApi = (data) =>
  shopRequest("/userCrmSlbum/create", data, "post", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// 删除图册
export const userCrmSlbumDeleteApi = (data) =>
  shopRequest("/userCrmSlbum/delete", data, "get", null, {
    "X-Dts-Admin-Token": uni.getStorageSync(USER_TOKEN),
  });

// 进入微店
export const enterSHopApi = (data) =>
  huangRequest("/microshop/toShop", data, "get");

// 获取微店数据列表
export const getMyshopGoodsListApi = (data) =>
  huangRequest("/microshop/queryUpList", data, "get");
...
export const downGoodsApi = (data) =>
  huangRequest("/microshop/down", data, "get");

// 申请区域代理
export const applyRegionagentApi = (data) =>
  shopRequest("/regionagent/saveRegionAgent", data);

// 查询区域代理状态
export const getApplyRegionagentStatusApi = (data) =>
  shopRequest("/regionagent/queryIsApproved", data, "get");

// 查询所有可领取的优惠劵
export const getAvailableCouponListApi = (data) =>
  shopRequest("/coupon/getUserCoupon", data, "get");
...
export const getCouponListApi = (data) =>
  shopRequest("/coupon/mylist", data, "get");
