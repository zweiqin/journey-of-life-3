	...
	<view class="character-configuration-container">
		...
		<view style="display: flex;justify-content: space-between;align-items: flex-end;margin: 14rpx auto;">
			<tui-button
				...
				@click="go('/another-tf/another-shop/shop-overview/character-configuration-form')"
			>
				新增字段
			</tui-button>
			<tui-button
						...
						<template #footer>
							<view style="display: flex;justify-content: flex-end;align-items: center;padding: 0 20rpx 20rpx;">
								<tui-button
									...
									@click="go(`/another-tf/another-shop/shop-overview/character-configuration-form?id=${item.id}`)"
								>
									编辑
								</tui-button>
								<tui-button
