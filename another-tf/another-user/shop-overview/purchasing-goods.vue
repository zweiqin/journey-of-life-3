	...
	<view class="purchasing-goods-container">
		...
		<view style="display: flex;justify-content: space-between;align-items: flex-end;margin: 14rpx auto;">
			<tui-button
				...
				@click="go('/another-tf/another-user/shop-overview/purchasing-goods-form')"
			>
				新增采购商品
			</tui-button>
			<tui-button
						...
						<template #footer>
							<view style="display: flex;justify-content: flex-end;align-items: center;padding: 0 20rpx 20rpx;">
								<tui-button
									...
									@click="go(`/another-tf/another-user/shop-overview/purchasing-goods-form?id=${item.purchasingGoodsId}`)"
								>
									编辑
								</tui-button>
								<tui-button
