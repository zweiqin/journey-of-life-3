			...
			<view>
				<view style="display: flex;align-items: center;flex-direction: column;">
					<view
						...
						:style="{ backgroundColor: [5, 6].includes(commissionRecordData.type) ? '#208f57' : [1, 2, 3, 4].includes(commissionRecordData.type) ? '#ef530e' : '#d8d8d8' }"
					>
						<text v-if="[5, 6].includes(commissionRecordData.type)">支</text>
					...
					<view style="margin-top: 32rpx;font-size: 42rpx;">
						{{ [5, 6].includes(commissionRecordData.type) ? '-'
